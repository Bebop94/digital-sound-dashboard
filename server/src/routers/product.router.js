...
const valCreacionMiddleware = require('../middlewares/valCreacionMiddleware')
const valModificacionMiddleware = require('../middlewares/valModificacionMiddleware')
...
router.post("/creacion-producto", upload.single('fotoProd'), valCreacionMiddleware, productController.creacion);
...
// Ruta para el la pag de edicion de productos, viene por POST del landing
router.post("/editar/:id", upload.single('fotoProd'), valModificacionMiddleware, productController.confirmarEdicion);
